      ...
      <h1>Editar Podcast</h1>
         ...
         (
           ...
           <Form.Group className='my-2'>
               <Form.Label><h4>Imagen</h4></Form.Label>
               <Form.Control
                   type='text'
           ...
           <Form.Group controlId='comment' className='my-2'>
            ...
            <Form.Group className='my-2'>
                <Form.Label><h4>Archivo de Audio</h4></Form.Label>
                <Form.Control
                    type='text'
                ...
                <Form.Group controlId='time_pod'>
                    <Form.Label><h4>Duración Podcast</h4></Form.Label>
                    <Form.Control
                        type='number'
                ...
                <Form.Label><h4>Transcripción</h4></Form.Label>
                    <Form.Control
                        type='text'
